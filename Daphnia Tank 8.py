...
os.system('modprobe w1-gpio')# poke the kernal for the location set for the one wire protocol for pi gpio
os.system('modprobe w1-therm')#indicate that sensor is temp
...
#Codeblock for generating a new data file every day
    ...
    time.sleep(30)#Sleep the control loop for 30 seconds until next cycle